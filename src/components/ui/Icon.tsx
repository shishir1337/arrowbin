 ...
 * Inline SVG keeps icons crisp, themeable and zero-request — no emoji icons.
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  linkedin: (
    <path d="M4.98 3.5a2.5 2.5 0 1 1-.02 5 2.5 2.5 0 0 1 .02-5zM3 9h4v12H3zM10 9h3.8v1.7h.06c.53-1 1.83-2.06 3.76-2.06 4.02 0 4.76 2.65 4.76 6.1V21h-4v-5.45c0-1.3-.02-2.97-1.81-2.97-1.81 0-2.09 1.41-2.09 2.87V21h-4z" />
  ),
  link: (
    <>
